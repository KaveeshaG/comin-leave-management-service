...
type LeaveService interface {
    ...
    CreateLeaveRequest(orgID uuid.UUID, req *domain.CreateLeaveRequest) (*domain.LeaveRequest, error)
...
func (s *leaveService) CreateLeaveRequest(orgID uuid.UUID, req *domain.CreateLeaveRequest) (*domain.LeaveRequest, error) {
    ...
    if err := s.leaveRepo.CreateLeaveRequest(orgID, leaveRequest); err != nil {
        return nil, err
    }
...
func (s *leaveService) UpdateLeaveRequest(orgId uuid.UUID, reqId uuid.UUID, request *domain.LeaveRequest, userID uuid.UUID) error {
    if request == nil {
        return errors.New("request is required")
    }
    err := s.leaveRepo.UpdateLeaveRequest(orgId, reqId, request, userID)
    if err != nil {
        return err
    }
    return nil
